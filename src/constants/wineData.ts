export const WINE_COUNTRIES = [
  'United States',
  'Argentina', 'Australia', 'Austria', 'Canada', 'Chile', 'Croatia',
  'France', 'Georgia', 'Germany', 'Greece', 'Hungary', 'Israel', 'Italy',
  'New Zealand', 'Portugal', 'Slovenia', 'South Africa', 'Spain',
  'Switzerland', 'Uruguay', 'Other',
];
...
export const WINE_REGION_DATA: Record<string, Record<string, string[]>> = {
  ...
  'United States': {
    ...
    'Mount Veeder': [],
    'Napa Valley': [
      'Coombsville', 'Diamond Mountain District', 'Howell Mountain', 'Mount Veeder',
      'Oak Knoll District', 'Oakville', 'Rutherford', 'Spring Mountain District',
      'St. Helena', 'Stags Leap District', 'Yountville',
    ],
    'North Coast': [],
    'Paso Robles': [],
    'Petaluma Gap': [],
    'Redwood Valley': [],
    'Rockpile': [],
    'Russian River Valley': ['Green Valley of Russian River Valley'],
    'Santa Barbara County': ['Happy Canyon', 'Los Olivos District', 'Santa Maria Valley', 'Santa Rita Hills', 'Santa Ynez Valley'],
    'Santa Clara Valley': [],
    ...
    'Sonoma Coast': [],
    'Sonoma County': [
      'Alexander Valley', 'Bennett Valley', 'Chalk Hill', 'Dry Creek Valley',
      'Fountaingrove District', 'Green Valley of Russian River Valley', 'Knights Valley',
      'Moon Mountain District', 'Petaluma Gap', 'Rockpile', 'Russian River Valley',
      'Sonoma Coast', 'Sonoma Valley', 'Yorkville Highlands',
    ],
    'Sonoma Valley': [],
    ...
    'Umpqua Valley': [],
    'Van Duzer Corridor': [],
    'Willamette Valley': ['Dundee Hills', 'Eola-Amity Hills', 'McMinnville', 'Ribbon Ridge', 'Van Duzer Corridor', 'Yamhill-Carlton'],
    'Yamhill-Carlton': [],
    // Texas AVAs
    ...
    'Ancient Lakes': [],
    'Columbia Valley': [
      'Ancient Lakes', 'Horse Heaven Hills', 'Lake Chelan', 'Naches Heights',
      'Rattlesnake Hills', 'Red Mountain', 'Royal Slope', 'Snipes Mountain',
      'Wahluke Slope', 'Walla Walla Valley', 'Yakima Valley',
    ],
    'Horse Heaven Hills': [],
    'Lake Chelan': [],
    'Naches Heights': [],
...
// Explicit map: AVA name → state. Used by offline label parser to format "AVA, State".
// The auto-derived approach doesn't work now that AVAs are the top-level keys.
export const US_AVA_TO_STATE: Record<string, string> = {
  ...
  // Napa Valley sub-AVAs (appear in subregion arrays, also need state mapping)
  'Coombsville': 'California',
  'Diamond Mountain District': 'California',
  'Howell Mountain': 'California',
