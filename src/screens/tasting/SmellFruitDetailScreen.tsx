...
import { FRUIT_ITEMS } from '../../constants/aromas';
import { useWineTasting } from '../../context/WineTastingContext';

type Nav = NativeStackNavigationProp<RootStackParamList>;
type Route = RouteProp<RootStackParamList, 'SmellFruitDetail'>;
...
export default function SmellFruitDetailScreen() {
  const navigation = useNavigation<Nav>();
  const route = useRoute<Route>();
  const { fruitType } = route.params;
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.bottomBar}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('SmellFruitType')}
        >
          <Text style={[styles.outlineBtnText, { color }]}>BACK TO ALL FRUIT</Text>
        </TouchableOpacity>
        <TouchableOpacity
